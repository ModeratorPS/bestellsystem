...
if ($DB_HOST == "") {
  header("location: setup-first.php");
};
...
?>
    <br><a href="/bestellen/kids.php" style="background-color: lightgreen;" class="u-btn u-btn-submit u-button-style"><img src="/bestellen/images/kids.png" width="35" height="30">  Im Kinder Modus Bestellen</a><br>
    <br><a href="/bestellen/Bestellen.php" class="u-btn u-btn-submit u-button-style">Jetzt Bestellen</a>
    <br>
