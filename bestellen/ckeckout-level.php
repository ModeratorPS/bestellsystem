...
<html style="font-size: 16px;" lang="de"><head>
    ...
    <title>Admin Level Checkout</title>
...
<form action="/bestellen/checkout-level-senden.php" method="post" name="form">
...
<input type="number" placeholder="Level" name="input2" id="input2"><br>
