              ...
              <div class="u-container-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <div class="u-form u-form-1">
                    <form action="/bestellen/kids-2.php" method="post" name="form" style="padding: 10px;">
                      <div class="u-form-group u-form-name">
                        <input type="text" placeholder="✍️ Name" id="input1" name="input1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
                      </div>
                      <input type="submit" class="u-btn u-btn-submit u-button-style" name="submit" value="📧" id="submit">
                    </form>
                  </div>
                </div>
              </div>
