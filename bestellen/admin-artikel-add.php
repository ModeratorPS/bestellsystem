...
Breite (200-300) (Kein Komma nur Punkt): <input type="text" placeholder="300" id="input3" name="input3"><br>
Höhe (200-300) (Kein Komma nur Punkt): <input type="text" placeholder="250" id="input4" name="input4"><br>
