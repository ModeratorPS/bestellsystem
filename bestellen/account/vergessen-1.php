              ...
              <div class="u-container-align-left u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-1">
                  <div class="u-form u-form-1">
                    <form action="vergessen-2.php" method="post">
                        <h2>Passwort vergessen</h2>
                        <div class="form-group">
                            <label>E-Mail</label>
                            <input type="mail" name="mail" id="mail" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" style="background-color: #E2E2E2;">
                        </div><br>
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary menu_button" value="Zurücksetzen">
                        </div>
                        <p>Ist dir dein Passwort wieder eingefallen? <br><a href="login.php">Jetzt Einloggen</a></p><br><br>
                    </form>
                  </div>
                </div>
              </div>
