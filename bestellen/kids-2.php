...
{
    echo '<br><a href="/bestellen/kids-senden.php?name='. $_POST['input1'] .'&artikel='. $zeile['artikel'] .'" style="background-color: lightgreen;" class="u-btn u-btn-submit u-button-style"><h3 style="color: gray;">'.$zeile['preis'].' Euro</h3><img src="'. $zeile['bild'] .'" width="'. $zeile['width'] .'" height="'. $zeile['height'] .'"></a>';
}
?> 
                      </div>
                    </form>
