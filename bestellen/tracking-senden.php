...
while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
{
  if ($zeile['Status'] == "0") {
    ...
    <li class="step0 active text-center" id="step2">In Bearbeitung</li>
    <li class="step0 active text-right" id="step3">Auf dem Weg</li>
    <li class="step0 active text-right" id="step4">Bestellung erfolgreich</li>';
  }
  else if ($zeile['Status'] == "4") {
    echo '<li class="step0 active" style="color: red;" id="step1"><strong>Bestellung storniert</strong></li>
    <li class="step0 text-center" id="step2"></li>
    <li class="step0 text-right" id="step3"></li>
...
?>
        ...
        <fieldset>
            ...
            <form action="/bestellen/tracking-stornieren.php" method="post" name="form" class="text">
...
if ($num_rows > "0") {
    while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
    {
        ...
        <strong style="color: gray;">Zusatz:</strong> '. $zeile['Zusatz'] .'<br><br>
        ';
    }
}
else {
...
?>
                <input name="submit" id="submit" <?php
require_once "config.php";
...
if ($num_rows > "0") {
    while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
    {
        if ($zeile['Status'] > "0") {
            if ($zeile['Status'] == "4") {
                echo 'type="submit" value="Storniert" class="closed_button" disabled';
            }
            else {
                echo 'type="submit" class="closed_button" value="Stornieren nicht mehr möglich" disabled';
            }
        }
        else {
            echo 'type="submit" value="Stornieren" class="open_button"';
        }
    }
}
else {
