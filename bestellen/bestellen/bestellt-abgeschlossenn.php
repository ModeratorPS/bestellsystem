...
<html style="font-size: 16px;" lang="de"><head>
    ...
    <title>Bestellen Abgeschlossen</title>
...
?>
      ...
      <section class="u-clearfix u-palette-3-light-3 u-section-1" id="sec-8f5b" align="center">
<style>
.menu_button {
    color: orange;
...
.menu_button:hover {
	...
	<h4 style='align: center' class="u-text-palette-4-base"><strong>Bestellung gesendet</strong></h4>
    <div align="center">
	<form action="../tracking/tracking-senden.php" method="post" name="form">
	    Deine ID: <br>
	    <input name="input1" id="input1" type="text" style="width: 50px;" value="<?php echo $_GET['id']; ?>" readonly><br><br>
	    <input class="menu_button" type="submit" name="submit" id="submit" value="Sofort Tracken">
	</form><br>
	<form action="<?php echo $LINK_BEWERTEN; ?>">
		<button class="menu_button" type="submit">Jetzt Bewerten</button>
	</form><br>
	<form action="../tracking/index.php">
