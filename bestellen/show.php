...
if ($time <= $SHOW_lightgreen) {
    echo '<img style="float: left; margin-right: 10px;" src="wartezeit/grün.png" width="85" hight="85"><h1 style="color: green">Geschätzte Wartezeit: <strong>'.$time.' minuten</strong></h1>';
} else if ($time <= $SHOW_darkgreen) {
    echo '<img style="float: left; margin-right: 10px;" src="wartezeit/grün.png" width="85" hight="85"><h1 style="color: olivedrab">Geschätzte Wartezeit: <strong>'.$time.' minuten</strong></h1>';
