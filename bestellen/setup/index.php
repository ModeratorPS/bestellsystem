...
<input value="<?php require_once "../config/config.php"; echo $DB_PASSWORD; ?>" type="text" placeholder="DB_PASSWORD" id="input3" name="input3" required=""><br>
<input value="<?php require_once "../config/config.php"; echo $DB_NAME; ?>" type="text" placeholder="DB_NAME" id="input4" name="input4" required=""><br>
<input value="<?php require_once "../config/config.php"; echo $RESTAURANT_NAME; ?>" type="text" placeholder="RESTAURANT_NAME" id="input5" name="input5" required=""><br>
<input value="<?php require_once "../config/config.php"; echo $MAIL_NEWS; ?>" type="text" placeholder="MAIL_NEWS" id="input6" name="input6" required=""><br>
<input value="<?php require_once "../config/config.php"; echo $MAIL_NEWS_LINK; ?>" type="text" placeholder="MAIL_NEWS_LINK" id="input7" name="input7" required=""><br>
...
<input value="<?php require_once "../config/config.php"; echo $SHOW_darkorange; ?>" type="text" placeholder="SHOW_darkorange" id="input15" name="input15" required=""><br>
<input value="<?php require_once "../config/config.php"; echo $SHOW_red; ?>" type="text" placeholder="SHOW_red" id="input16" name="input16" required=""><br>
