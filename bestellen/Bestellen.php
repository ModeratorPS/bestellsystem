                  ...
                  <div class="u-form u-form-1">
                    <form action="/bestellen/bestellen-senden.php" method="post" name="form" style="padding: 10px;">
                      <div class="u-form-group u-form-name">
                        ...
                        <input type="text" placeholder="Geben Sie Ihren Namen ein" id="input1" name="input1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" value="<?php echo $_SESSION["username"]; ?>" required="">
                      </div>
