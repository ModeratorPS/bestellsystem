    ...
    while($zeile = mysqli_fetch_array( $result5, MYSQLI_ASSOC)) {
      if ($zeile['bedingung'] == "Mittel") {
        echo '<div align="center">
          <br><br><form action="bestellen-alter-senden.php?name='. $input1 .'&mail='. $input2 .'&bestellung='. $input3 .'&zusatz='. $input4 .'&id='. $input5 .'&code='. $input8 .'" method="post" name="form">
      ...
      if ($zeile['bedingung'] == "Stark") {
        ...
        echo '<div align="center">
          <br><br><form action="bestellen-alter-senden.php?name='. $input1 .'&mail='. $input2 .'&bestellung='. $input3 .'&zusatz='. $input4 .'&id='. $input5 .'&code='. $input8 .'" method="post" name="form">
            <strong>Bitte gebe dein Geburtsjahr ein: </strong><br><input type="number" style="width: 60px;" value="'.date('Y').'" id="input2" name="input2"name="input2" name="input2"><br><br>
            <input type="submit" name="submit" id="submit" value="Senden" class="menu_button">
          </form><br><br>
        </div>';
        exit;
      ...
      if ($zeile['bedingung'] == "Ultra") {
        echo '<div align="center">
          <br><br><form action="bestellen-passwort-senden.php?name='. $input1 .'&mail='. $input2 .'&bestellung='. $input3 .'&zusatz='. $input4 .'&id='. $input5 .'&code='. $input8 .'" method="post" name="form">
