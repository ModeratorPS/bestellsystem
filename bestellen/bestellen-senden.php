...
while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
{
  ...
  if ($zeile['Status'] == "Geöffnet") {
    ...
    while ($zeile2 = mysqli_fetch_array( $db_erg2, MYSQLI_ASSOC)) {
      if ($zeile2['TG'] == "Ja") {
        echo '<div align="center">
          <br><br><form action="bestellen-tgsenden.php?name='. $input1 .'&mail='. $input2 .'&bestellung='. $input3 .'&zusatz='. $input4 .'&id='. $input5 .'" method="post" name="form">
    ...
    $query = "INSERT INTO `bestellungen` (`Name`, `E-Mail`, `Bestellung`, `Zusatz`, `ID`, `Status`) VALUES ('$input1', '$input2', '$input3', '$input4', '$input5', '0');"; 
