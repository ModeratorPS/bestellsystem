...
while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
{
  if ($zeile['Status'] == '0') {
    ...
    echo "<td>". $zeile['Bestellzeit'] . "</td>";
    echo "<td>". $zeile['Name'] . "</td>";
    echo '<td><p style="color: red;">Storniert</p></td>';
    echo "</tr>";
  } else {
    echo "<tr>";
    echo "<td>". $zeile['Bestellzeit'] . "</td>";
    echo "<td>". $zeile['Name'] . "</td>";
    echo '<td><p style="color: green;">In Bearbeitung / Fertig</p></td>';
    echo "</tr>";
  }
}
echo "</table>";
