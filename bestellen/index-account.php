...
while ($zeile = mysqli_fetch_array( $db_erg1, MYSQLI_ASSOC))
{
  ...
  echo '<td> <a style="color: gray;" href="bestellen-tgsenden.php?name='. $zeile['Name'] .'&mail='. $zeile['E-Mail'] .'&bestellung='. $zeile['Bestellung'] .'&zusatz='. $zeile['Zusatz'] .'&id='. rand(1000, 9999) .'&tg='. $zeile['TG'] .'">Erneut Bestellen</a> </td>';
  echo "</tr>";
}
echo "</table>";
mysqli_free_result( $db_erg1 );
