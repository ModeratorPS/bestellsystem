...
.number_count.filled input[type="text"] {
    color: gray;
}
</style>
    ...
    <section class="u-clearfix u-grey-5 u-section-2" id="carousel_a603">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
          <div class="u-layout">
<form action="achievement-senden.php" method="post" name="form">
<h4>Achievements:</h4>
<table>
  <?php
  ...
  foreach ($result as $zeile) {
    echo "<fieldset>";
      echo '<div class="number_count"><input type="text" id="'.$zeile["id"].'" name="'.$zeile["id"].'" required="" value="'.$zeile["count"].'">x '.$zeile["type"]." für ".$zeile["achievement"]."</div>";
    echo "</fieldset>";
  }
  ?>
</table><br>
