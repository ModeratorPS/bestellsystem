...
if ($_POST["input1"] != "") {
  ...
  $sql_create_code = "INSERT INTO `rabattcodes` (`code`, `rabatt`) VALUES ('$input1', '$input2');";
  $sql_create_code_result = mysqli_query($link, $sql_create_code);
  header('location: index.php');
}
?>
<!DOCTYPE html>
<html style="font-size: 16px;" lang="de"><head>
    ...
    <title>💳 - Rabattcode erstellen</title>
    ...
    <section class="u-clearfix u-section-1" id="carousel_9c88">
      <div class="infinite u-container-align-center u-container-style u-custom-color-2 u-expanded-width u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-valign-middle u-container-layout-1">
          <form action="rabattcode.php" method="post" name="form">
            ...
            <input type="submit" class="u-border-2 u-border-black u-btn u-button-style u-hover-black u-none u-text-hover-white u-btn-1" name="submit" id="submit">
          </form>
        </div>
      </div>
    </section>
